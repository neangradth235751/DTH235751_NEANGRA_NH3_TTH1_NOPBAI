...
# thiết lập độ rộng các cột (set_column('A:A', 5) sets the width of column A to 5)
...
# thêm dòng dữ liệu thứ nhất (hàng 2)
worksheet.write('A2', 1)
worksheet.write('B2', 'SP1')
worksheet.write('C2', 'Coca')
worksheet.write('D2', 15)   # Nên dùng số nguyên/thực thay vì chuỗi cho Số Lượng
worksheet.write('E2', 15000) # Nên dùng số nguyên/thực thay vì chuỗi cho Đơn Giá

# thêm dòng dữ liệu thứ hai (hàng 3)
...
# Đóng file để lưu lại các thay đổi
workbook.close()
